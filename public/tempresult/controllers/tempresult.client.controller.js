...
['$scope', 
 ...
 function($scope, $http,  $location,  Authentication, Tempresult, ngTableParams, $modal, $log, ConvertArray) {
   ...
   this.modelUpdate = function (size, selectedTemplate) {
        var modalInstance = $modal.open({
          templateUrl: 'tempresult/views/edit-tempresult.client.view.html',
  ...
  ['$scope', 
   ...
   function($scope, $http, $routeParams,  Authentication, Tempresult) {
        ...
        this.update = function(template){
            var template = new Tempresult({ 
                _id:    $scope.selectedTemplate._id,      
                reportname:   $scope.selectedTemplate.reportname,
                tipomuestra:  $scope.selectedTemplate.tipomuestra,
                resultado:   $scope.selectedTemplate.resultado,
                tecnica:  $scope.selectedTemplate.tecnica,
                nota:  $scope.selectedTemplate.nota,
                diagnostico:  $scope.selectedTemplate.diagnostico
            });
